...
class IntervieweesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create interviewee" do
    assert_difference('Interviewee.count') do
      post interviewees_url, params: { interviewee: { email: @interviewee.email, name: @interviewee.name } }
    end
  ...
  test "should update interviewee" do
    patch interviewee_url(@interviewee), params: { interviewee: { email: @interviewee.email, name: @interviewee.name } }
