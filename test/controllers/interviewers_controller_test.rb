...
class InterviewersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create interviewer" do
    assert_difference('Interviewer.count') do
      post interviewers_url, params: { interviewer: { email: @interviewer.email, name: @interviewer.name } }
    end
  ...
  test "should update interviewer" do
    patch interviewer_url(@interviewer), params: { interviewer: { email: @interviewer.email, name: @interviewer.name } }
